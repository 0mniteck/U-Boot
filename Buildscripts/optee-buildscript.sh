...
do
  ...
  pushd /$plat/optee_ftpm-$OPT_VER
    ...
    sed -i "s'ECC_CURVE_DATA'ECC_CURVE_25519'" include/TEE/TpmToTEEMath.h
    TPMCmd/tpm/cryptolibs/TpmBigNum/include/TpmBigNum/TpmToTpmBigNumMath.h
    sed -i "12d;36d;83,97d;104,105d;109d;112d;116,309d" sub.mk
...
echo "srcs_ext-y += X509/TpmASN1.c
