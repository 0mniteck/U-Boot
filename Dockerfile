...
RUN apt install clang cmake codespell gdb-multiarch gettext help2man libclang-rt-dev libncurses-dev lld python3-pycryptodome python3-pycodestyle texinfo -y
