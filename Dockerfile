...
RUN apt install -y build-essential gcc-5 acpica-tools nasm unzip uuid-dev wget python3-distutils
...
ADD https://github.com/tianocore/edk2-platforms/archive/$EDKP_VER.zip
